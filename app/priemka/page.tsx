...
export default function Page() {
    ...
    const handlePrintAcceptance = (detail: AcceptanceDetail) => {
    ...
    const handlePrintAcceptanceFromHistory = async (id: number) => {
        try {
            ...
            handlePrintAcceptance(data as AcceptanceDetail)
        } catch (error) {
            console.error(error)
    ...
    const handleCommit = async () => {
        ...
        try {
            ...
            if (isEditMode && editingAcceptance?.id) {
                await openAcceptanceModal(editingAcceptance.id)
            }
        } catch (error) {
            console.error(error)
                                        ...
                                        <div className="flex items-center justify-between gap-2">
                                            ...
                                            <div className="flex shrink-0 items-center gap-2">
                                                <button
                                                    ...
                                                    className="rounded-md bg-white px-2 py-1 text-xs text-green-700 hover:bg-green-100"
                                                >
                                                    Открыть
                                                </button>
                                                ...
                                                <button
                                                    ...
                                                    className="rounded-md bg-white px-2 py-1 text-xs text-blue-700 hover:bg-blue-100"
                                                >
                                                    Печать
                                                </button>
                        ...
                        <>
                            <div className="grid grid-cols-2 md:grid-cols-4 xl:grid-cols-8 gap-2">
                                ...
                                <div className="rounded-xl bg-white p-3 shadow-sm">
                                    ...
                                    <div className="text-xl font-bold">{Math.round(summary.totalPurchase)}</div>
                                </div>

                                <div className="rounded-xl bg-white p-3 shadow-sm">
                                    <div className="text-xs text-gray-500">Продажа</div>
                                    <div className="text-xl font-bold">{Math.round(summary.totalSelling)}</div>
                                </div>
                            </div>
