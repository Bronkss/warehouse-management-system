                ...
                <form onSubmit={handleSubmit} className="auth-form flex flex-col pt-[78px]">
                    ...
                    <div className="auth-password-wrap relative">
                        <input
                            ...
                            className="auth-input auth-password-input h-[60px] w-full rounded-[22px] border-[2px] border-[#e67c63] px-6 pr-16 text-[19px] text-[#222] placeholder:text-[#b9b9b9] outline-none"
                        />
                        ...
                        <button
                            ...
                            className="auth-password-toggle absolute right-4 top-1/2 flex h-10 w-10 -translate-y-1/2 items-center justify-center rounded-full text-[#777] transition hover:bg-[#f6e2dd] hover:text-[#e67c63] focus:outline-none focus:ring-2 focus:ring-[#e67c63]/30"
                        >
                            {isPasswordVisible ? (
                                <svg
                                    viewBox="0 0 24 24"
                                ...
                                >
                                    ...
                                    <path d="M9.88 4.24A10.94 10.94 0 0 1 12 4c7 0 10 8 10 8a16.19 16.19 0 0 1-2.11 3.45" />
                                    <path d="M6.61 6.61C3.89 8.44 2 12 2 12s3 8 10 8a10.82 10.82 0 0 0 5.39-1.39" />
                                </svg>
                            ) : (
                                <svg
                                    viewBox="0 0 24 24"
